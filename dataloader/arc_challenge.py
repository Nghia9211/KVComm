...
class ARCChallengeEvaluator(BaseEvaluator):
    ...
    def __init__(self, n_samples: int = None):
        super().__init__()
        self.max_tokens = 2048      # Paper (LatentMAS Section 4): 2048 for ARC-Challenge
        ...
        self.configure_task_profile(prompt_family="latentmas", task_type="qa", sender_input_mode="shared_problem", answer_format="boxed_choice", prompt_version="latentmas_two_agent_v1", primary_metric="legacy_match", sender_max_tokens=1024)
